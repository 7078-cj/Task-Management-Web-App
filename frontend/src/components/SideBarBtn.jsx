...
function SideBarBtn({path,pathName}) {
  return (
    <Link to={path}> 
        <button
          class="relative flex items-center px-6 py-3 overflow-hidden font-medium transition-all bg-indigo-500 rounded-md group w-[350px]"
        >
          <span
          ...
          ></span>
          <span
            class="relative w-full text-white transition-colors duration-200 ease-in-out group-hover:text-white text-center"
            >{pathName}</span>
        </button>
        </Link>
